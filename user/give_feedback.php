...
if($r==true)
{
echo "<h2 style='color:red'> YOU HAVE ALREADY GIVEN THE FEEDBACK ! STILL THANKYOU</h2>";
}
else
{
$query="insert into feedback values('','$user','$quest1','$quest2','$quest3','$quest4','$quest5','$quest6','$quest7','$quest8','$quest9','$quest10','$quest11','$quest12','$quest13','$quest14',now())";
...
<tr>
<td><b>2:</b>THE WHOLE PROJECT ACCORDING TO YOUR RATING:</td> 
...
<tr>
<td>
<b>9:</b> HOW MUCH YOU HAVE LIKED IT:</td> 
...
<tr>
<td>
<b>10:</b> HOW WAS THE WHOLE PROJECT:</td>
<td>
...
<h3>EXPERIENCE</h3>
 <table  class="table table-bordered" >
<tr>
<td><b>11:</b>WHAT WAS YOU SEARCHING FOR ? HAVE YOU GAINED IT...:</td>
<td>
...
<b>13:</b>ADDITION COMMENTS IF ANY:<br><br>
<center>
<textarea name="quest13" rows="5" cols="60" id="comments" style="font-family:sans-serif;font-size:1.2em;">

</textarea></center><br><br>
<b>14:</b>IF YOU WILL REFER THIS PROJECT TO ANYBODY.. MENTIONS THEIR DETAILS TOO:<br><br>
<center>
